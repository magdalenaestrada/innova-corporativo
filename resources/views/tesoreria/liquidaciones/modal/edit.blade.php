<div class="modal fade text-left" id="ModalEdit{{ $liquidacion->id }}" role="dialog" aria-hidden="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="form-group mt-1 col-md-6 g-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="otros_descuentos"
                                        disabled
                                ...
                                <div class="form-group mt-1 col-md-6 g-3">
                                    ...
                                    <input name="monto" type="text" class="form-control form-control-sm"
                                        id="monto" value="{{ $liquidacion->salidacuenta->monto }}">
                                </div>
