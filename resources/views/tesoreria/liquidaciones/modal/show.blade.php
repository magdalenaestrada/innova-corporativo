<div class="modal fade text-left" id="ModalShow{{ $liquidacion->id }}" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <div class="card-body">
                    ...
                    <div style="margin-top: -1.5%;" class=" text-center mb-3">
                    ...
                    @if ($liquidacion->cliente)
                        <div class="col-md-12 text-right" style="font-size: 13px; margin-top: -5%">
                            <p>RUC: {{ $liquidacion->cliente->documento }} </p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4 g-3">
                                ...
                                <input class="form-control form-control-sm" value="{{ $liquidacion->created_at }}"
                                    disabled>
                            </div>
                            @if ($liquidacion->sociedad)
                                <div class="form-group col-md-4 g-3">
                                    ...
                                    <input class="form-control form-control-sm"
                                        value="{{ $liquidacion->sociedad->nombre }}" disabled>
                            ...
                            @if ($liquidacion->creador)
                                <div class="form-group col-md-4 g-3 ">
                                    ...
                                    <input class="form-control form-control-sm"
                                        value="{{ $liquidacion->creador->name }}" disabled>
                                </div>
                            @endif
                        ...
                        <div class="form-group col-md-12 g-3">
                            ...
                            <textarea class="form-control form-control-sm" disabled>{{ $liquidacion->salidacuenta->descripcion ? $liquidacion->salidacuenta->descripcion : 'No hay descripción' }}</textarea>
                        </div>
                    @endif
                                                ...
                                                @foreach ($liquidacion->adelantos as $adelanto)
                                                    <tr>
                                                        ...
                                                        <td scope="row">
                                                            @php
                                                                if (
                                                                    $adelanto->salidacuenta->cuenta->tipomoneda
                                                                        ->nombre == 'DOLARES'
                                                                ) {
                                                                    $coin_simbol = '$';
                                                                } else {
                        ...
                        <div class="row">
                            <div class="form-group mt-1 col-md-6 g-3">
                                ...
                                <input type="text" class="form-control form-control-sm" id="otros_descuentos" disabled value="{{ $coin_simbol.'   ' }}{{ $liquidacion->otros_descuentos ? number_format($liquidacion->otros_descuentos, 2) : '0.00' }}">
                            </div>
    
                            <div class="form-group col-md-6 g-3 text-center" style="margin-top:30px">
                               
                                <p class="h5"><strong>MONTO PAGADO:</strong>
    
                                    {{ $coin_simbol . '   ' }}
                                    {{ number_format($liquidacion->salidacuenta->monto, 2) ? number_format($liquidacion->salidacuenta->monto, 2) : 'No hay descripción' }}
                                </p>
                            </div>
                        </div>
